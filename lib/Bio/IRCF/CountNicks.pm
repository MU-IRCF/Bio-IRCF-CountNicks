...
Then download the L<latest CountNicks tarball|https://github.com/MU-IRCF/Bio-IRCF-CountNicks/raw/master/current_distribution/Bio-IRCF-CountNicks.tar.gz>.
...
=head1 First-time Perl installation on Ubuntu
